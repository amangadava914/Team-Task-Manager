        ...
        <div className="w-full bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 px-6 xl:px-16 py-3 flex-shrink-0">
            <div className="flex items-center justify-between max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {isAuthenticated && (
                        <div className="flex items-center gap-3">
                            <div className="hidden sm:block text-sm text-zinc-700 dark:text-zinc-300">
                                {user?.name || user?.email}
                            </div>
                            <button onClick={handleLogout} className="size-8 flex items-center justify-center rounded-lg bg-white dark:bg-zinc-800 shadow transition hover:bg-zinc-100 dark:hover:bg-zinc-700 p-2">
                                <LogOut className="size-4 text-zinc-700 dark:text-zinc-200" />
                            </button>
                        </div>
                    )}
